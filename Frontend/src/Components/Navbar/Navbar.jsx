    ...
    return (
        <nav className="navbar-container">
            ...
            <div className="navbar-left-container">
                <div id="openSidebar" onClick={openSidebarHanle} className="sidebar-open-btn">
            ...
            <div className="navbar-icons">
                <a href="#" className="navbar-bell-icon"> <img src={bellIcon} alt="Bell icon"/> </a>
                <a href="#" className="navbar-profile-icon"> <img src={profileIcon} alt="Profile Icon"/> </a>
            </div>
        </nav>
    );
}
